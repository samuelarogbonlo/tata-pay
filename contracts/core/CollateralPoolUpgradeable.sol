...
/**
 * @title CollateralPoolUpgradeable
 * @notice Manages USDC collateral deposits from fintechs for payment settlements (UUPS Upgradeable)
 ...
 */
contract CollateralPoolUpgradeable is
    Initializable,
    ...
    UUPSUpgradeable
{
    ...
    /// @notice USDC token interface (no longer immutable for upgradeable)
    IERC20 public USDC;
    ...
    /**
     * @notice Initialize the CollateralPool contract (replaces constructor)
